...
module {
  tt.func public @tensor_first_wrap_side_by_side_masked_loop(
      %arg0: !tt.ptr<f32>,
      %arg1: !tt.ptr<f32>,
      %arg2: i32,
      %arg3: i32,
...
// CHECK-LABEL: func.func @tensor_first_wrap_side_by_side_masked_loop
// CHECK:      tensor.empty
// CHECK:      linalg.fill
...
module {
  tt.func public @tensor_first_wrap_stacked_masked_loop(
      %arg0: !tt.ptr<f32>,
      %arg1: !tt.ptr<f32>,
      %arg2: i32,
      %arg3: i32,
...
// CHECK-LABEL: func.func @tensor_first_wrap_stacked_masked_loop
// CHECK:      tensor.empty
// CHECK:      linalg.fill
// CHECK:      bufferization.to_tensor
// CHECK:      tensor.insert_slice
